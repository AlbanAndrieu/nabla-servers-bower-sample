...
export WEBDRIVER_CHROME_VERSION=${WEBDRIVER_CHROME_VERSION:-"103.0.5060.134"}

echo -e "${magenta} npm install -g bower@1.8.13 grunt@1.5.3 webdriver-manager@12.1.8 ${NC}"
