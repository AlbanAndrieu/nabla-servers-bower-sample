...
rm nohup.out
nohup java -jar /workspace/selenium-server-standalone-2.52.0.jar -role hub -port 4444 -Dwebdriver.chrome.driver=/usr/lib/chromium-browser/chromedriver -debug &
tail -f nohup.out
