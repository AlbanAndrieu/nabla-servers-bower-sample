...
public class Deployment_IT {
    ...
    public void testBaseUrl() throws Exception {
        ...
        assertEquals(
                format("Error getting main screen for %s at address %s",
                        Deployment_IT.DEFAULT_CONTEXT, Deployment_IT.BASE_URL),
                HttpURLConnection.HTTP_OK, service_response);
        ...
        assertEquals(
                format("Error getting main screen for %s at address %s",
                        Deployment_IT.DEFAULT_CONTEXT, Deployment_IT.BASE_URL),
                HttpURLConnection.HTTP_OK, good_service_response);
    }
    ...
    public void testProxyUrl() throws Exception {
        ...
        assertEquals(
                format("Error getting main screen for %s at address %s",
                        Deployment_IT.DEFAULT_CONTEXT, Deployment_IT.LOGIN_URL),
        ...
        assertEquals(
                format("Error getting main screen for %s at address %s",
                        Deployment_IT.DEFAULT_CONTEXT, Deployment_IT.LOGIN_URL),
                HttpURLConnection.HTTP_MOVED_TEMP, good_service_response);
    }
    ...
    public void testBaseRest() throws Exception {
        ...
        assertEquals(
                format("Error getting login screen for %s at address %s", DEFAULT_CONTEXT, LOGIN_URL),
                200, docResponse.getStatus());
    }
